package com.vuralsoftware.vbgs.fragments.notekle;
...
public class Notekle extends Fragment {
    ...
    private NotekleViewModel mViewModel;
    ...
    public static Notekle newInstance() {
        return new Notekle();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_notekle, container, false);
    ...
    public void verieklenot(View vw){
        ...
        mFireStore.collection("kullanicilar").document(mUser.getUid()).collection("hayvanlar").document(veri).collection("notlar").document()
                .set(mData)
                .addOnCompleteListener((Activity) getContext(), new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            NavDirections action = new ActionOnlyNavDirections(R.id.action_nav_Notekle_to_nav_Notlar);
