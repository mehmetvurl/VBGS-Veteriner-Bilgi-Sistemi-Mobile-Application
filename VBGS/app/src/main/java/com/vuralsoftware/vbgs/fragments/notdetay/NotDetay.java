package com.vuralsoftware.vbgs.fragments.notdetay;
...
public class NotDetay extends Fragment {

    private NotDetayViewModel mViewModel;
    ...
    public static NotDetay newInstance() {
        return new NotDetay();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_notdetay, container, false);
        nvb= new BottomView();
        veri=nvb.bilginot1();
        ...
        docref= mFireStore.collection("kullanicilar").document(mUser.getUid()).collection("hayvanlar").document(veri).collection("notlar").document(veri1);
        docref.get()
