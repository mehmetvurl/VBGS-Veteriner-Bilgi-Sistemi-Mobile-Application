...
public class Genelnot extends Fragment {

    private GenelnotViewModel mViewModel;
    ...
    public static Genelnot newInstance() {
        return new Genelnot();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_genelnot,container,false);

        //küpe verisi çekme
        veri=nvb.bilginot1();


        noteref=db.collection("kullanicilar").document(mUser.getUid()).collection("notlar");
        setUpRecyclerView(v);

        //Not Ekle Hayvan Verisi Gönderme ve Yönlendirme

        FloatingActionButton fbtn=v.findViewById(R.id.noteklebtn);
        fbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NavDirections action = new ActionOnlyNavDirections(R.id.action_nav_GenelNotlar_to_nav_GenelNotEkle);
    ...
    private void setUpRecyclerView(View v) {
        ...
        RecyclerView recyclerView = v.findViewById(R.id.genelnot_recyclerview);
        ...
        adapterNote.setOnItemClickListener(new NoteAdapter.onItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                NavDirections action = new ActionOnlyNavDirections(R.id.action_nav_GenelNotlar_to_nav_GenelNotDetay);
                Navigation.findNavController(v).navigate(action);
